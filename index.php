...
<body>
    ...
    <aside class="float_right">
        ...
        <img src="images/valid-html-blue.png" alt="This site has valid HTML!" style="width:12em; height:auto;">
        <img src="images/valid-css-blue.png" alt="This site has valid CSS!" style="width:12em; height:auto;">
    </aside>
