...
<body>
    ...
    <aside class="float_right">
        ...
        <img src="images/valid-html-blue.png" alt="This site has valid HTML!" class="small_tags">
        <img src="images/valid-css-blue.png" alt="This site has valid CSS!" class="small_tags">
    </aside>
